"""
Django settings for mysuba project.
...
SECRET_KEY = 'ed^kp6!)nvkm4z&ic_f)%o3mo%k$a6+rp#lhi5s+p(x6ylf_mp'
...
WSGI_APPLICATION = 'mysuba.wsgi.application'
